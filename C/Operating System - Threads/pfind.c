...
int is_th_queue_empty(){//return true is array_threads_queue is empty
    ...
    return start_th_queue == -1 || end_th_queue == -1;
...
void delete_th_queue(){//when I am inside I hold lock_for_queue || inside i also hold another lock
    ...
    if(we_start_the_end == 1){//it's over :(
        //do nothing 
    }
    else if(counter_curr_th_waiting>0){
...
void insert_th_queue(){//when I am inside I hold lock_for_queue
    ...
    mtx_unlock(&lock_for_array_threads);
    //int check;
    if(counter_curr_th_waiting == max_threads_waiting || (start_th_queue == 0 && end_th_queue == max_threads_waiting-1) || (start_th_queue == end_th_queue+2) || (start_th_queue == 0 && end_th_queue == max_threads_waiting-2) || (start_th_queue == end_th_queue+3) || (start_th_queue == 0 && end_th_queue == max_threads_waiting)|| (start_th_queue == end_th_queue+1)){//queue full
